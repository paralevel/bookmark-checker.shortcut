...
Finds variant URLs that end/don't end with a hash (#) string/URI fragment or a "/", and also URLs with the same title – useful for example when the URL has been changed since the page was bookmarked (not available in clipboard/manual mode). 
